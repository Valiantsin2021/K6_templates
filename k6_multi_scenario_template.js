...
// Process arguments
const TOKEN_USERNAME = __ENV.TOKEN_USERNAME ? __ENV.TOKEN_USERNAME : 'fakeuser'

const TOKEN_PASSWORD = __ENV.TOKEN_PASSWORD ? __ENV.TOKEN_PASSWORD : 'fakepassword'
...
let Execution = TEST_2_RUN // ExecutionType.smoke;
